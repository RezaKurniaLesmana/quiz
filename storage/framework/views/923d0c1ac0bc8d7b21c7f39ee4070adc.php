...
unset($__errorArgs, $__bag); ?>" id="kode" placeholder="Input kode" value="<?php echo e(old('gol_kode')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row mb-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="gol_nama" class="form-control" id="nama" placeholder="Input nama" value="<?php echo e(old('gol_nama')); ?>" required>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ary\quiz-muara\resources\views/golongan/create.blade.php ENDPATH**/ ?>