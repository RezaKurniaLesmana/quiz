...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-warning bg-warning">
        ...
        <a class="navbar-brand ps-3" href="/home">
            <img src="<?php echo e(asset('img/listrik.jpeg')); ?>" class="rounded-circle" width="30px"> SI-PLN
        </a>
        <!-- Sidebar Toggle-->
...
<?php /**PATH C:\xampp\htdocs\ary\quiz-reza\resources\views/layouts/main.blade.php ENDPATH**/ ?>