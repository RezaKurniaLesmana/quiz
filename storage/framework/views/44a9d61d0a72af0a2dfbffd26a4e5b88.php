...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/ikon-listrik.jpeg')); ?>">
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a class="navbar-brand ps-3" href="/home">
            <img src="<?php echo e(asset('img/ikon-listrik.jpeg')); ?>" class="rounded-circle" width="30px"> SI-PLN
        </a>
        <!-- Sidebar Toggle-->
...
<?php /**PATH C:\xampp\htdocs\ary\quiz-muara\resources\views/layouts/main.blade.php ENDPATH**/ ?>